...
@Component({
  ...
  template: `
    ...
    >
      <!-- Header -->
      <div
        class="tw-mx-6 tw-mb-1 tw-mt-6 tw-flex tw-animate-pulse tw-items-center sm:tw-mx-8"
      >
        <div
          class="tw-mr-4 tw-h-10 tw-w-10 tw-rounded-full tw-bg-gray-300"
        ></div>
        <div class="tw-flex tw-flex-col tw-gap-1">
          <div class="tw-h-3 tw-w-24 tw-rounded-2xl tw-bg-gray-300"></div>
          <div class="tw-h-3 tw-w-16 tw-rounded-2xl tw-bg-gray-300"></div>
        </div>
      </div>
      ...
      <!-- Actions -->
      <div
        class="tw-mx-3 tw-flex tw-h-10 tw-animate-pulse tw-items-center tw-text-gray-600 sm:tw-mx-5"
      >
        <div
      ...
      <div
        class="tw-mx-6 tw-mb-4 tw-flex tw-h-10 tw-animate-pulse tw-flex-col tw-justify-end sm:tw-mx-8 sm:tw-mb-6 sm:tw-flex-row sm:tw-items-center"
      >
        <div
